...
from cm.pc_datasets import load_data
...
def main():
    ...
    model_and_diffusion_kwargs["datatype"] = datatype
    ...
    # )
    data = load_data(train_data_dir = args.train_data_dir,datatype = args.datatype, max_frame=args.max_frame, fix_orientation=args.fix_ori,
                                    step_multiplier=1, jump_step=args.jump_step, batch_size = args.batch_size, num_workers = args.num_workers, class_cond=args.class_cond)
...
def create_argparser():
    ...
    defaults.update(cm_3dtrain_defaults())
